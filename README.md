...
InterRelax.test_compute_stability_number_of_graph(data) #Table 3
InterRelax.test_compute_stability_number_of_graph_ball_constr(data) #Table 4
InterRelax.test_MAXCUT(data) #Table 5

InterRelax.test_CertifyNNHousing(data) #Table 8
InterRelax.test_CertifyNNDigits(data) #Table 9

InterRelax.test_dense_POP_arbcons(data) #Tables 10 and 17
InterRelax.test_CS_POP_arbcons(data) #Tables 11 and 18
InterRelax.test_PMSV(data) #Table 12
InterRelax.test_compute_stability_number_of_graph_random(data) #Table 13
InterRelax.test_deciding_copositivity(data) #Table 14
InterRelax.test_deciding_nonegativity(data) #Table 15
InterRelax.test_dense_POP_binary_constr_random(data) #Table 16
